...
<?php if (\Core\Auth::esAdminAcademico()): ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Recarga por filtros
            $('#filtro-dni, #filtro-nombres').on('keyup', function() {
                tabla.ajax.reload();
            });
            $('#filtro-programa, #filtro-plan, #filtro-semestre, #filtro-turno, #filtro-seccion').on('change', function() {
                tabla.ajax.reload();
            });
            ...
            $('#btnBuscarMatricula').on('click', function() {
                ...
                if (!dni) {
                    $('#msgBuscarMatricula').text('Ingrese DNI');
                    return;
                }
