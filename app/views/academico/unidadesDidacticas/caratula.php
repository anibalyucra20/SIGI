...
<table width="100%">
    <tr>
        <td width="20%"></td>
        <td width="60%" style="text-align: center; font-size: 13px; border: 1px solid #000;"><br><b>HORARIO<br></b><span style="font-size:13px;"><?php $horario = nl2br($silabo['horario']); echo $horario; ?></span></td>
        <td width="20%"></td>
    </tr>
</table>
<br>
