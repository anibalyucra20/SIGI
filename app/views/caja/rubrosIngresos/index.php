...
<?php if (\Core\Auth::esAdminCaja()): ?>
    <div class="card p-2">
        <h3 class="mb-2">Rubros de Ingresos</h3>
        <div class="col-md-2 mb-2">
            <a href="<?= BASE_URL ?>/caja/rubrosIngresos/nuevo" class="btn btn-success mt-2">Nuevo +</a>
        </div>
        ...
        <div class="table-responsive col-12">
            <table id="tabla-rubrosIngresos" class="table table-bordered table-hover table-sm align-middle">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const tabla = $('#tabla-rubrosIngresos').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                ajax: {
                    url: '<?= BASE_URL ?>/caja/rubrosIngresos/data',
                    type: 'GET',
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                        <a href="<?= BASE_URL ?>/caja/rubrosIngresos/editar/${row.id}" class="btn btn-warning btn-sm">Editar</a>
                    `;
                        }
                    }
                ],
