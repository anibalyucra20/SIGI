<div class="row">
  ...
  <div class="mb-2 col-md-4">
    <label class="form-label">Clasificador de Ingresos *</label>
    <input type="text" name="clasificador_ingresos" class="form-control" maxlength="30" required value="<?= htmlspecialchars($data['clasificador_ingresos'] ?? '') ?>">
  </div>
  <div class="mb-2 col-md-4">
    <label class="form-label">Precio Unitario *</label>
    <input type="text" name="precio_unit" class="form-control" maxlength="11" required value="<?= htmlspecialchars($data['precio_unit'] ?? '') ?>">
  </div>
