...
<?php if (\Core\Auth::esAdminCaja()): ?>
    <div class="card p-2">
        <h3 class="mb-2">Ingresos Contables</h3>
        <div class="col-md-2 mb-2">
            <a href="<?= BASE_URL ?>/caja/ingresosContables/nuevo" class="btn btn-success mt-2">Nuevo +</a>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 mb-2 text-center position-relative sd-container" data-rows-per-page="10">
                ...
                <input type="hidden" name="id_rubro_ingreso_contable" id="id_rubro_ingreso_contable" class="sd-id">
                <!-- Input visible para buscar/mostrar texto -->
                <input type="text" class="form-control sd-input" placeholder="Buscar tipo de ingreso..." autocomplete="off" required id="txt1">
                <!-- Dropdown con tabla -->
                    ...
                    <div style="max-height: 250px; overflow-y: auto;">
                        <table class="table table-hover table-sm mb-0">
                            ...
                            <tbody class="sd-tbody">
                                <?php foreach ($RubrosIngreso as $rubro):
        ...
        <div class="table-responsive col-12">
            <table id="tabla-ingresosContables" class="table table-bordered table-hover table-sm align-middle">
                <thead class="table-light">
                    <tr>
                        <th>#</th>
                        <th>Fecha</th>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const tabla = $('#tabla-ingresosContables').DataTable({
                ...
                searching: false,
                ajax: {
                    url: '<?= BASE_URL ?>/caja/ingresosContables/data',
                    type: 'GET',
                    data: function(d) {
                        d.fecha_desde = $('#fecha_desde').val();
                        d.fecha_hasta = $('#fecha_hasta').val();
                        d.correlativo = $('#correlativo').val();
                        d.id_rubro_ingreso_contable = $('#id_rubro_ingreso_contable').val();
                ...
                columns: [{
                    ...
                    {
                        data: 'descripcion_rubro_ingreso_contable'
                    },
                    {
                        data: 'total_ingreso'
                    },
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                        <a href="<?= BASE_URL ?>/caja/ingresosContables/editar/${row.id}" class="btn btn-warning btn-sm">Editar</a>
                    `;
                        }
                    }
                ],
