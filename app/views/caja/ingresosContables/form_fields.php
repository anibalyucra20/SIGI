...
<div class="row">
  ...
  <div class="col-md-12 p-1 position-relative sd-container" data-rows-per-page="10">
    ...
    <input type="hidden" name="id_rubro_ingreso_contable" class="sd-id" value="<?= htmlspecialchars($data['id_rubro_ingreso_contable'] ?? '') ?>">
  ...
  <div class="col-md-3 p-1">
    ...
    <input type="text" name="total_ingreso" class="form-control" maxlength="100" required value="<?= htmlspecialchars($data['total_ingreso'] ?? '') ?>">
  </div>
  <div class="col-md-3 p-1">
