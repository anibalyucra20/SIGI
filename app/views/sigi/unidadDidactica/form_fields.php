...
<div class="mb-3 row">
    <div class="col-md-2">
        ...
        <input type="number" name="creditos_teorico" class="form-control" min="0" max="20" required
            value="<?= htmlspecialchars($ud['creditos_teorico'] ?? '') ?>">
    </div>
    <div class="col-md-2">
        <label class="form-label">Créditos Prácticos*</label>
        <input type="number" name="creditos_practico" class="form-control" min="0" max="20" required
