...
<h3 class="mb-4">SISTEMA DE BOLSA LABORAL</h3>
...
<div class="row">
  <?php if (\Core\Auth::tieneRolEnBolsa()): ?>
    ...
    <?php endif; ?>
    <?php if (\Core\Auth::tieneRolEnBolsa()|| \Core\Auth::esDirectorAcademico()|| \Core\Auth::esJUAAcademico()|| \Core\Auth::esSecretarioAcadAcademico()|| \Core\Auth::esAdminAcademico()): ?>
      <div class="col-md-3">
