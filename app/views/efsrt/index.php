...
<h3 class="mb-4">SISTEMA DE EFSRT</h3>
...
<div class="row">
  <?php if (\Core\Auth::tieneRolEnEfsrt()): ?>
    ...
    <?php endif; ?>
    <?php if (\Core\Auth::tieneRolEnEfsrt()|| \Core\Auth::esDirectorAcademico()|| \Core\Auth::esJUAAcademico()|| \Core\Auth::esSecretarioAcadAcademico()|| \Core\Auth::esAdminAcademico()): ?>
      <div class="col-md-3">
