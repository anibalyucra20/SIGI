        ...
        <ul class="navbar-nav">
            ...
            <?php if (\Core\Auth::tieneRolEnAdmision()): ?>
                <?php if (\Core\Auth::esAdminAdmision()): ?>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?= BASE_URL ?>/admision/postulantes">
                            <i class="far fa-address-book"></i> Postulantes
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="nav-periodos">
                            ...
                            <a href="<?= BASE_URL ?>/admision/calificaciones" class="dropdown-item">Subir Resultadoss</a>
                            <a href="<?= BASE_URL ?>/admision/modalidades" class="dropdown-item">Modalidades</a>
                            <a href="<?= BASE_URL ?>/admision/metas" class="dropdown-item">Metas de Atencion</a>
                            <a href="<?= BASE_URL ?>/admision/programacion" class="dropdown-item">Programacion</a>
