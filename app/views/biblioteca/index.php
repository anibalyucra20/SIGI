...
<h3 class="mb-4">BIBLIOTECA VIRTUAL</h3>
<?php if (!\Core\Auth::esAdminBiblioteca() && \Core\Auth::tieneRolEnBiblioteca()): ?>
  <h4 class="mb-4">Ultimos Libros Leídos</h4>
  <div class="row">

  </div>
  <h4 class="mb-4">Libros Favoritos</h4>
  <div class="row">
