...
<div class="">
    <div class="mb-3">
        <a href="<?= BASE_URL ?>/biblioteca/busqueda" class="btn btn-light btn-sm">
            ← Volver
        </a>
    </div>
    ...
    <div class="book-hero p-3 p-md-4">
        <div class="row">
            ...
            <div class="col-12 p-3">
                <button class="btn btn-outline-success">Añadir a Favoritos</button>
                <?php if (!empty($file)): ?>
                    <a class="btn btn-outline-secondary" target="_blank" rel="noopener" href="<?= htmlspecialchars($file, ENT_QUOTES, 'UTF-8') ?>">
                        Descargar
                    </a>
                <?php endif; ?>
            </div>
