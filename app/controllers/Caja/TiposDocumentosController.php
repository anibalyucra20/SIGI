...
class TiposDocumentosController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->view('caja/tiposDocumentos/index', [
            'module'    => 'caja',
    ...
    public function nuevo()
    {
        ...
        $this->view('caja/tiposDocumentos/nuevo', [
            //'programas' => $programas,
            'data' => [],
            'module' => 'caja',
            'pageTitle' => 'Nuevo Tipo de Documento'
        ]);
    ...
    public function guardar()
    {
        if (\Core\Auth::esAdminCaja()):
            ...
            if ($errores) {
                $this->view('caja/tiposDocumentos/' . $link, [
                    'errores'   => $errores,
                    'data'   => $data,
                    'module'    => 'caja',
                    'pageTitle' => $title . ' Tipo de Documento',
                    'isEdit'    => $editar
                ]);
                return;
            }
            $this->model->guardar($data);
            $_SESSION['flash_success'] = "Tipo de Documento guardado correctamente";
        endif;
        header('Location: ' . BASE_URL . '/caja/tiposDocumentos');
        exit;
    }
    ...
    public function editar($id)
    {
        ...
        $this->view('caja/tiposDocumentos/editar', [
            'data' => $data,
            'isEdit'    => true,
            'module' => 'caja',
