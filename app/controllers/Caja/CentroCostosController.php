...
class CentroCostosController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->view('caja/centroCostos/index', [
            'module'    => 'caja',
    ...
    public function nuevo()
    {
        ...
        $this->view('caja/centroCostos/nuevo', [
            //'programas' => $programas,
            'cap' => [],
            'module' => 'caja',
            'pageTitle' => 'Nuevo Centro de Costo'
        ]);
    ...
    public function guardar()
    {
        if (\Core\Auth::esAdminCaja()):
            ...
            if ($errores) {
                $this->view('caja/centroCostos/' . $link, [
                    'errores'   => $errores,
                    'data'   => $data,
                    'module'    => 'caja',
            ...
            $_SESSION['flash_success'] = "Centro de costos guardado correctamente";
        endif;
        header('Location: ' . BASE_URL . '/caja/centroCostos');
        exit;
    }
    ...
    public function editar($id)
    {
        ...
        $this->view('caja/centroCostos/editar', [
            'data' => $data,
            'isEdit'    => true,
            'module' => 'caja',
            'pageTitle' => 'Editar Centro de Costos'
        ]);
        exit;
    }
}
