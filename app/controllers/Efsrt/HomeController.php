...
class HomeController extends Controller
{
    public function __construct()
    {
        ...
        $moduloAcademico = 11;   // ID del sistema ACADEMICO (ajusta si es diferente)
    ...
    public function index()
    {
        ...
        $this->view('efsrt/index', [
            'periodo'   => $periodo,
            'docentes'  => $docentes,
            'pageTitle' => 'Sistema de EFSRT',
            'module'    => 'efsrt'
        ]);
    }
}
