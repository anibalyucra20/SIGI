...
class HomeController extends Controller
{
    public function __construct()
    {
        ...
        $moduloAcademico = 5;   // ID del sistema ACADEMICO (ajusta si es diferente)
        ...
        if ($_SESSION['sigi_modulo_actual'] != $moduloAcademico) {
            ...
            if (!\Core\Auth::tieneRolEnAdmision()) {
                $_SESSION['flash_error'] = "No tienes permisos para acceder a este módulo.";
                header('Location: ' . BASE_URL . '/intranet');
                exit;
            }
    ...
    public function index()
    {
        ...
        $this->view('admision/index', [
            'periodo'   => $periodo,
            'docentes'  => $docentes,
            'pageTitle' => 'Sistema de Admisión',
            'module'    => 'admision'
        ]);
    }
}
